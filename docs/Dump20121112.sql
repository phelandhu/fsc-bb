...
INSERT INTO `Campaigns` VALUES (0,0,'MID-Month',0,18,'2012-06-15','USD'),(23,1,'Start Of Month 3',0,12,'2012-06-15','USD'),(24,0,'Start Of Month',0,12,'2012-06-15','USD'),(25,1,'End of business',0,56,'2012-06-15','USD'),(26,0,'Mike Test',0,5,'2012-07-31','USD'),(27,1,'Test Campaign',1,1,'0000-00-00','USD'),(28,1,'Test Campaign',1,1,'0000-00-00','USD');
...
INSERT INTO `RulesManagementSet` VALUES (284,'Sample Rule Set D',1,1,1),(285,'Sample Rule Set D',2,1,1),(286,'Sample Rule Set D',3,1,1),(287,'Sample Rule Set D',4,1,1),(288,'Sample Rule Set D',5,1,1),(289,'Sample Rule Set D',6,1,1),(290,'Sample Rule Set D',7,1,1),(291,'Sample Rule Set D',8,1,1),(292,'Sample Rule Set D',9,1,1),(293,'Sample Rule Set D',10,1,1),(294,'Sample Rule Set D',11,1,1),(295,'Sample Rule Set D',12,1,1),(297,'Sample Rule Set D',14,1,1),(298,'Sample Rule Set D',15,1,1),(299,'Sample Rule Set D',16,0,1),(300,'Sample Rule Set D',17,1,1),(335,'Sample Rule Set D',18,1,1),(336,'Sample Rule Set D',19,1,1),(337,'Testing Default',1,1,0),(338,'Testing Default',2,1,0),(339,'Testing Default',3,1,0),(340,'Testing Default',4,1,0),(341,'Testing Default',5,1,0),(342,'Testing Default',6,0,0),(343,'Testing Default',7,0,0),(344,'Testing Default',8,1,0),(345,'Testing Default',9,1,0),(346,'Testing Default',10,0,0),(347,'Testing Default',11,0,0),(348,'Testing Default',12,1,0),(349,'Testing Default',14,1,0),(350,'Testing Default',15,1,0),(351,'Testing Default',16,0,0),(352,'Testing Default',17,1,0),(353,'Testing Default',19,1,0),(354,'Testing Default',18,0,0);
...
INSERT INTO `rules` VALUES (1,'Reject loan if email includes .mil ','Reject loan if email includes .mil ','validate_text_contains','.mil','email'),(2,'Reject loan if email includes .gov ','Reject loan if email includes .gov ','validate_text_contains','.gov','email'),(3,'ABA is invalid ','ABA is invalid ','validate_numeric_equalEqualTo_CharCount','9','ROUTINGNUMBER'),(4,'Customer or spouse is in military ','Customer or spouse is in military ','validate_isTrue','Errors','ISMILITARY'),(5,'Deny if bankruptcy','Deny if bankruptcy','validate_isTrue','Errors','BANKRUPTCY'),(6,'Deny Loan if customer has a \"Hold\" flag','Deny Loan if customer has a \"Hold\" flag','validate_text_contains','Hold','Flag'),(7,'Deny new loan if customer has a \"Deny\" flag','Deny new loan if customer has a \"Deny\" flag ','validate_text_contains','Deny','Flag'),(8,'Employment date must be greater than or equal to 60 days ','Employment date must be greater than or equal to 60 days','validate_date_xdaysGreater','60','EMPMONTHS'),(9,'Payment Type cannot be paper check','Payment Type cannot be paper check','validate_text_contains','P','PAYTYPE'),(10,'Loan due date cannot be on a holiday ','Loan due date cannot be on a holiday ','validate_date_isHoliday','Errors','LOANDUEDATE'),(11,'Loan due date cannot be on a weekend ','Loan due date cannot be on a weekend','validate_date_isWeekEnd','Errors','LOANDUEDATE'),(12,'Minimum monthly Income of $1000','Minimum monthly Income of $1000','validate_numeric_lesser','1000','NETMONTHLY'),(14,'Minimum residence duration of 1 month(s)','Minimum residence duration of 1 month(s)','validate_numeric_greaterThanEqualTo','1','LENGTHATRESIDENCE'),(15,'Valid home phone number','Valid home phone number','validate_numeric_equalEqualTo_CharCount','10','HOMEPHONE'),(16,'Verify that Drivers License number does not exist for another applicant','Verify that Drivers License number does not exist for another applicant','validate_Data_Exist','Errors','driverslicense'),(17,'Checking account must be open for 1 months or greater ','Checking account must be open for 1 months or greater ','validate_numeric_greaterThanEqualTo','1','LENGTHBANKING'),(19,'Payment Type cannot be cash','Payment Type cannot be cash','validate_text_contains','C','PAYTYPE'),(18,'Account # is invalid ','Account # is invalid ','validate_numeric_equalEqualTo_CharCount','17','ACCOUNTNUMBER');
...
-- Dump completed on 2012-11-12 16:58:02
