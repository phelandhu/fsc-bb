...
--
-- Host: localhost
-- Generation Time: Sep 20, 2012 at 11:18 PM
...
INSERT INTO `Campaigns` (`id`, `isActive`, `Name`, `LeadProviderID`, `PurchasePrice`, `StartDate`, `Currency`) VALUES
...
INSERT INTO `LeadProvider` (`id`, `CompanyName`, `PrimaryPhoneNumebr`, `TechnicalPOCName`, `TechnicalPOCEmailAddress`, `SalesPOCName`, `SalesPOCEmailAddress`, `IntegrationDate`, `APIField1`, `APIField2`, `SendingURL`) VALUES
...
INSERT INTO `rules` (`id`, `Title`, `RuleDescription`, `PHPLocation`, `value`, `FieldName`) VALUES
...
INSERT INTO `RulesManagementSet` (`id`, `Title`, `rulesID`, `Active`, `memberID`) VALUES
