...
--
-- Host: localhost
-- Generation Time: Aug 05, 2012 at 07:08 PM
...
(14, 'Minimum residence duration of 1 month(s)', 'Minimum residence duration of 1 month(s)', 'validate_numeric_greaterThanEqualTo', '1', 'LENGTHATRESIDENCE'),
(15, 'Valid home phone number', 'Valid home phone number', 'validate_numeric_equalEqualTo_CharCount', '10', 'HOMEPHONE'),
(16, 'Verify that Drivers License number does not exist for another applicant', 'Verify that Drivers License number does not exist for another applicant', 'validate_Data_Exist', 'Errors', 'driverslicense'),
(17, 'Checking account must be open for 1 months or greater ', 'Checking account must be open for 1 months or greater ', 'validate_numeric_greaterThanEqualTo', '1', 'LENGTHBANKING'),
(19, 'Payment Type cannot be cash', 'Payment Type cannot be cash', 'validate_text_contains', 'C', 'PAYTYPE'),
...
(289, 'Sample Rule Set D', 6, 1, 1),
(290, 'Sample Rule Set D', 7, 1, 1),
(291, 'Sample Rule Set D', 8, 1, 1),
(292, 'Sample Rule Set D', 9, 1, 1),
(293, 'Sample Rule Set D', 10, 1, 1),
(294, 'Sample Rule Set D', 11, 1, 1),
(295, 'Sample Rule Set D', 12, 1, 1),
(297, 'Sample Rule Set D', 14, 1, 1),
(298, 'Sample Rule Set D', 15, 1, 1),
(299, 'Sample Rule Set D', 16, 0, 1),
(300, 'Sample Rule Set D', 17, 1, 1),
(335, 'Sample Rule Set D', 18, 1, 1),
(336, 'Sample Rule Set D', 19, 1, 1),
